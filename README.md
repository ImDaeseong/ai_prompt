...
| 시나리오·웹소설·드라마 구조를 설계하고 싶다 | [scenario_writer_hermes_Prompts.md](./scenario_writer_hermes_Prompts.md) | 장르, 로그라인 아이디어, 대상 매체 |
...
```text
project_보안_초기설계_Prompts.md
        ↓
MFC:    mfc_프로젝트생성_Prompts.md
Python: python_프로젝트생성_Prompts.md
        ↓
필요 시 최종 검수 또는 문서화 프롬프트 실행
```
...
mfc_프로젝트_구조_Prompts.md
        ↓
mfc_프로젝트_정밀분석_Prompts.md
        ↓
이슈 수정
        ↓
mfc_프로젝트_최종검수_Prompts.md
```
...
- [antigravity_test](./antigravity_test/README.md): 창의적 글쓰기, 에이전트 스킬, 프롬프트 엔지니어링 실험 모음
