...
- **Do NOT add this skill to a persona's `skills:` frontmatter.** A persona that follows Step 3 would spawn another persona — an orchestration anti-pattern: personas must not invoke other personas. Only the main-session orchestrator uses this skill.
