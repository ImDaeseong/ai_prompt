...
# list) so this repo has the same real-looking-secret gate. Kept as a
# separate PowerShell copy rather than a shared import, matching this repo's
# existing all-PowerShell script convention.
$secretPatterns = @(
